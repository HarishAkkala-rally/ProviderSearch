...
class AuthUtils {
  ...
  def newXSRFCookie(
   sessionId: SessionId
    ...
    val authServiceConfig = new AuthServiceConfig()
...
object AuthUtils {
  ...
  def newUserSession(
    ...
    newSession(AuthServiceConfig.RallyOrUserIDSessionHeaderName, userId)
...
class AuthServiceConfig() {
  lazy val XSRFCookieDomain: Option[String] = None
  lazy val XSRFCookieMaxAge: Option[Int] = Some(7)
  lazy val XSRFCookiePath: String = ""
  lazy val XSRFCookieSecure: Boolean = true
}
